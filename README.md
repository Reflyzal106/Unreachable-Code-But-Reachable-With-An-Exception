# [SOLVED] Unreachable-Code-But-Reachable-With-An-Exception
...
>
> ### ➡️ [CLICK HERE TO VIEW THE FULL FIX GUIDE](https://techfixdocs.my.id/unreachable-code-but-reachable-with-an-exception)
>
...
Use a try-catch block to handle the InvalidOperationException and return false when it occurs.
...
👉 **[Go to ErrorFix Hub Full Article](https://techfixdocs.my.id/unreachable-code-but-reachable-with-an-exception)**
